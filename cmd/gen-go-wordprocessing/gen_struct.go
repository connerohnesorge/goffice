...
// It checks against a known list of WordprocessingML root elements.
func isPartRootType(name string) bool {
	roots := []string{
		"/w:document", "/w:styles", "/w:numbering", "/w:fonts",
		"/w:settings", "/w:webSettings", "/w:footnotes", "/w:endnotes",
		"/w:comments", "/w:hdr", "/w:ftr", "/w:glossaryDocument",
	}
