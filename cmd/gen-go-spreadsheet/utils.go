...
// It includes specialized DrawingML and SpreadsheetML types.
...
// For example, "x:workbook" becomes "workbook".
...
func getGoNamespace(uri string) string {
	switch uri {
	case nsSpreadsheetML:
		return "openxml.NamespaceSpreadsheetML"
