...
type SchemaFileMetadata struct {
	...
	Namespace string
	// NamespacePrefix is the derived namespace prefix (p14, p15, a14, etc.).
...
// Examples:
//   - "schemas_microsoft_com_office_powerpoint_2010_main.json" → Office2010
//   - "schemas_microsoft_com_office_drawing_2013_main_command.json" → Office2013
//   - "schemas_microsoft_com_office_presentationml_2024_inkPicture.json" → Office2024
...
// Examples:
//   - PowerPoint 2010: "http://schemas.microsoft.com/office/powerpoint/2010/main" → "p14"
//   - PowerPoint 2013: "http://schemas.microsoft.com/office/powerpoint/2012/main" → "p15"
...
// prefixToVersion converts a namespace prefix to a FileFormatVersion.
// Examples: "p14" → Office2010, "p15" → Office2013, "a16" → Office2016
