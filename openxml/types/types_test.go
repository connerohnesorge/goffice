...
func TestPackageExists(t *testing.T) {
	...
	t.Log("types package test infrastructure is working")
}
...
func TestStringValue(t *testing.T) {
	t.Run("NewStringValue", func(t *testing.T) {
		...
		if sv.InnerText() != "hello" {
			t.Errorf("InnerText = %q, want %q", sv.InnerText(), "hello")
		}
	})
	...
	t.Run("NilStringValue", func(t *testing.T) {
		...
		if sv.Value() != "" {
			t.Errorf("Value = %q, want empty", sv.Value())
		}
	})
	...
	t.Run("SetValue", func(t *testing.T) {
		...
		sv.SetValue("world")
		if !sv.HasValue() {
			t.Error("HasValue should be true after SetValue")
		}
		if sv.Value() != "world" {
			t.Errorf("Value = %q, want %q", sv.Value(), "world")
		}
	})
	...
	t.Run("SetNil", func(t *testing.T) {
		...
		sv.SetNil()
		if sv.HasValue() {
			t.Error("HasValue should be false after SetNil")
		}
	})
	...
	t.Run("SetInnerText", func(t *testing.T) {
		...
		if err := sv.SetInnerText("parsed"); err != nil {
			t.Errorf("SetInnerText error: %v", err)
		}
		if sv.Value() != "parsed" {
			t.Errorf("Value = %q, want %q", sv.Value(), "parsed")
		}
	})
}
...
func TestInt32Value(t *testing.T) {
	t.Run("NewInt32Value", func(t *testing.T) {
		...
		if iv.Value() != 42 {
			t.Errorf("Value = %d, want %d", iv.Value(), 42)
		}
		if iv.InnerText() != "42" {
			t.Errorf("InnerText = %q, want %q", iv.InnerText(), "42")
		}
	})
	...
	t.Run("NegativeValue", func(t *testing.T) {
		...
		if iv.Value() != -100 {
			t.Errorf("Value = %d, want %d", iv.Value(), -100)
		}
		if iv.InnerText() != "-100" {
			t.Errorf("InnerText = %q, want %q", iv.InnerText(), "-100")
		}
	})
}
...
func TestUInt32Value(t *testing.T) {
	t.Run("NewUInt32Value", func(t *testing.T) {
		...
		if uv.Value() != 4294967295 {
			t.Errorf("Value = %d, want %d", uv.Value(), 4294967295)
		}
	})
...
func TestInt64Value(t *testing.T) {
	t.Run("LargeValue", func(t *testing.T) {
		...
		if iv.Value() != 9223372036854775807 {
			t.Errorf("Value = %d, want max int64", iv.Value())
		}
	})
}
...
func TestBooleanValue(t *testing.T) {
	...
	t.Run("OutputFormatTrueFalse", func(t *testing.T) {
		bv := NewBooleanValue(true)
		if bv.InnerText() != "true" {
			t.Errorf("InnerText = %q, want %q", bv.InnerText(), "true")
		}
	})

	t.Run("OutputFormatOneZero", func(t *testing.T) {
		bv := NewBooleanValueWithFormat(true, BooleanFormatOneZero)
		if bv.InnerText() != "1" {
			t.Errorf("InnerText = %q, want %q", bv.InnerText(), "1")
		}
	})
...
func TestOnOffValue(t *testing.T) {
	...
	t.Run("OutputFormats", func(t *testing.T) {
		...
		if ov.InnerText() != "on" {
			t.Errorf("InnerText = %q, want %q", ov.InnerText(), "on")
		}

		ov.SetOutputFormat(OnOffFormatTrueFalse)
		if ov.InnerText() != "true" {
			t.Errorf("InnerText = %q, want %q", ov.InnerText(), "true")
		}

		ov.SetOutputFormat(OnOffFormatOneZero)
		if ov.InnerText() != "1" {
			t.Errorf("InnerText = %q, want %q", ov.InnerText(), "1")
		}
	})
}
...
func TestEnumValue(t *testing.T) {
	...
	t.Run("NewEnumValue", func(t *testing.T) {
		...
		if ev.Value() != JustCenter {
			t.Errorf("Value = %q, want %q", ev.Value(), JustCenter)
		}
		if ev.InnerText() != "center" {
			t.Errorf("InnerText = %q, want %q", ev.InnerText(), "center")
		}
	})
	...
	t.Run("WithValidation", func(t *testing.T) {
		...
		ev := NewEnumValueWithValidation(JustLeft, validValues)
...
func TestHexBinaryValue(t *testing.T) {
	t.Run("NewHexBinaryValue", func(t *testing.T) {
		hv := NewHexBinaryValue([]byte{0xFF, 0x00, 0xAB})
		if !hv.HasValue() {
			t.Error("HasValue should be true")
		}
		if hv.InnerText() != "FF00AB" {
			t.Errorf("InnerText = %q, want %q", hv.InnerText(), "FF00AB")
		}
	})
	...
	t.Run("ParseHex", func(t *testing.T) {
		...
		if !bytes.Equal(hv.Value(), expected) {
			t.Errorf("Value = %v, want %v", hv.Value(), expected)
		}
	})
	...
	t.Run("ParseLowercase", func(t *testing.T) {
		...
		if hv.Len() != 3 {
			t.Errorf("Len = %d, want %d", hv.Len(), 3)
		}
	})
...
func TestBase64BinaryValue(t *testing.T) {
	t.Run("NewBase64BinaryValue", func(t *testing.T) {
		bv := NewBase64BinaryValue([]byte("Hello"))
		if !bv.HasValue() {
			t.Error("HasValue should be true")
		}
		if bv.InnerText() != "SGVsbG8=" {
			t.Errorf("InnerText = %q, want %q", bv.InnerText(), "SGVsbG8=")
		}
	})
	...
	t.Run("ParseBase64", func(t *testing.T) {
		...
		if string(bv.Value()) != "Hello" {
			t.Errorf("Value = %q, want %q", string(bv.Value()), "Hello")
		}
	})

	t.Run("InvalidBase64", func(t *testing.T) {
		bv := NewNilBase64BinaryValue()
		err := bv.SetInnerText("not-valid-base64!!!")
		if err == nil {
...
func TestDateTimeValue(t *testing.T) {
	...
	t.Run("ParseISO8601", func(t *testing.T) {
		...
		if dv.Value().Year() != 2024 {
			t.Errorf("Year = %d, want 2024", dv.Value().Year())
		}
		if dv.Value().Month() != time.January {
			t.Errorf("Month = %v, want January", dv.Value().Month())
		}
		if dv.Value().Day() != 15 {
			t.Errorf("Day = %d, want 15", dv.Value().Day())
		}
	})
...
func TestDecimalValue(t *testing.T) {
	t.Run("NewDecimalValue", func(t *testing.T) {
		...
		if dv.Value() != 3.14159 {
			t.Errorf("Value = %v, want 3.14159", dv.Value())
		}
	})
...
func TestTwipsValue(t *testing.T) {
	t.Run("NewTwipsValue", func(t *testing.T) {
		...
		if tv.Value() != 1440 {
			t.Errorf("Value = %d, want 1440", tv.Value())
		}
	})

	t.Run("ToPoints", func(t *testing.T) {
		tv := NewTwipsValue(20) // 1 point = 20 twips
		if tv.ToPoints() != 1.0 {
			t.Errorf("ToPoints = %v, want 1.0", tv.ToPoints())
		}
	})

	t.Run("ToInches", func(t *testing.T) {
		tv := NewTwipsValue(1440) // 1 inch = 1440 twips
		if tv.ToInches() != 1.0 {
			t.Errorf("ToInches = %v, want 1.0", tv.ToInches())
		}
	})

	t.Run("FromPoints", func(t *testing.T) {
		tv := NewTwipsValueFromPoints(72) // 72 points = 1 inch = 1440 twips
		if tv.Value() != 1440 {
			t.Errorf("Value = %d, want 1440", tv.Value())
		}
	})
...
func TestHalfPointsValue(t *testing.T) {
	t.Run("ToPoints", func(t *testing.T) {
		hv := NewHalfPointsValue(24) // 24 half-points = 12 points
		if hv.ToPoints() != 12.0 {
			t.Errorf("ToPoints = %v, want 12.0", hv.ToPoints())
		}
	})

	t.Run("FromPoints", func(t *testing.T) {
		hv := NewHalfPointsValueFromPoints(12) // 12 points = 24 half-points
		if hv.Value() != 24 {
			t.Errorf("Value = %d, want 24", hv.Value())
		}
	})
}
...
func TestEmuValue(t *testing.T) {
	t.Run("ToInches", func(t *testing.T) {
		ev := NewEmuValue(914400) // 914400 EMU = 1 inch
		if ev.ToInches() != 1.0 {
			t.Errorf("ToInches = %v, want 1.0", ev.ToInches())
		}
	})

	t.Run("ToPoints", func(t *testing.T) {
		ev := NewEmuValue(12700) // 12700 EMU = 1 point
		if ev.ToPoints() != 1.0 {
			t.Errorf("ToPoints = %v, want 1.0", ev.ToPoints())
		}
	})
	...
	t.Run("FromInches", func(t *testing.T) {
		...
		if ev.Value() != 914400 {
			t.Errorf("Value = %d, want 914400", ev.Value())
		}
	})
	...
	t.Run("FromCentimeters", func(t *testing.T) {
		...
		if ev.Value() != 360000 {
			t.Errorf("Value = %d, want 360000", ev.Value())
		}
	})
}
...
func TestPercentageValue(t *testing.T) {
	t.Run("NewPercentageValue", func(t *testing.T) {
		pv := NewPercentageValue(50000) // 50000 = 50%
		if !pv.HasValue() {
			t.Error("HasValue should be true")
		}
		if pv.Value() != 50000 {
			t.Errorf("Value = %d, want 50000", pv.Value())
		}
	})
	...
	t.Run("ToFloat", func(t *testing.T) {
		...
		if pv.ToFloat() != 0.5 {
			t.Errorf("ToFloat = %v, want 0.5", pv.ToFloat())
		}
	})
	...
	t.Run("ToPercent", func(t *testing.T) {
		...
		if pv.ToPercent() != 50.0 {
			t.Errorf("ToPercent = %v, want 50.0", pv.ToPercent())
		}
	})
	...
	t.Run("ParsePercentString", func(t *testing.T) {
...
func TestSimpleValueInterface(t *testing.T) {
	...
	for i, v := range values {
		if !v.HasValue() {
			t.Errorf("values[%d].HasValue() = false, want true", i)
		}
		if v.InnerText() == "" {
			t.Errorf("values[%d].InnerText() is empty", i)
		}
	}
}
...
func TestResettableInterface(t *testing.T) {
	...
	for i, r := range resettables {
		...
		sv, ok := r.(SimpleValue)
		if !ok {
			t.Errorf("resettables[%d] does not implement SimpleValue", i)
			continue
		}
		if sv.HasValue() {
			t.Errorf("resettables[%d].HasValue() = true after SetNil, want false", i)
		}
	}
}
