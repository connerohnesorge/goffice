...
func newThemePart(
	...
	if err := workbookPart.AddPart(tp, relID); err != nil {
		return nil, err
	}
...
// Register the ThemePart type for spreadsheets.
// Note: The wordprocessing package also registers this content type.
// The last registration wins, but both factories produce equivalent results.
func init() {
	openxml.RegisterPartType(
		&openxml.PartTypeInfo{
			...
			DefaultURI:         "/xl/theme/theme1.xml",
