...
// DiagramStylePart represents a diagram style part (word/diagrams/quickStyle1.xml, etc.).
...
func newDiagramStylePart(
	...
	if err := mainPart.AddPart(dsp, relID); err != nil {
		return nil, err
	}
...
func init() {
	openxml.RegisterPartType(
		&openxml.PartTypeInfo{
			...
			DefaultURI:         "/word/diagrams/quickStyle1.xml",
