...
// DiagramColorsPart represents a diagram colors part (word/diagrams/colors1.xml, etc.).
...
func newDiagramColorsPart(
	...
	if err := mainPart.AddPart(dcp, relID); err != nil {
		return nil, err
	}
...
func init() {
	openxml.RegisterPartType(
		&openxml.PartTypeInfo{
			...
			DefaultURI:         "/word/diagrams/colors1.xml",
