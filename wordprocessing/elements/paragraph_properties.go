...
func NewParagraphProperties() *ParagraphProperties {
	...
	return &ParagraphProperties{CompositeElementBase: elem}
}
...
func (pp *ParagraphProperties) SetParagraphStyleId(id string) {
	if id == "" {
...
func (pp *ParagraphProperties) SetJustification(j JustificationValue) {
...
func (pp *ParagraphProperties) Indentation() *Indentation {
	...
	if comp, ok := elem.(*openxml.CompositeElementBase); ok {
		return &Indentation{CompositeElementBase: comp}
	}
	return nil
}

// SetIndentation sets the indentation settings.
func (pp *ParagraphProperties) SetIndentation(ind *Indentation) {
	// Remove existing
...
func (pp *ParagraphProperties) SpacingBetweenLines() *SpacingBetweenLines {
	...
	if comp, ok := elem.(*openxml.CompositeElementBase); ok {
		return &SpacingBetweenLines{CompositeElementBase: comp}
	}
	return nil
}
...
func (pp *ParagraphProperties) SetKeepNext(b bool) {
...
func (pp *ParagraphProperties) SetKeepLines(b bool) {
...
func (pp *ParagraphProperties) SetPageBreakBefore(b bool) {
...
func (pp *ParagraphProperties) WidowControl() bool {
	...
	elem := pp.GetElement("widowControl", NamespaceWML)
	if elem == nil {
		return true // default
	}
	attr, found := elem.GetAttribute("val", NamespaceWML)
...
func (pp *ParagraphProperties) SetWidowControl(b bool) {
	if b {
		pp.removeElement("widowControl") // true is default
	} else {
...
func (pp *ParagraphProperties) NumberingProperties() *NumberingProperties {
	...
	if comp, ok := elem.(*openxml.CompositeElementBase); ok {
		return &NumberingProperties{CompositeElementBase: comp}
	}
	return nil
}
...
func (pp *ParagraphProperties) ParagraphBorders() *ParagraphBorders {
	...
	if comp, ok := elem.(*openxml.CompositeElementBase); ok {
		return &ParagraphBorders{CompositeElementBase: comp}
	}
	return nil
}
...
func (pp *ParagraphProperties) OutlineLevel() int {
	elem := pp.GetElement("outlineLvl", NamespaceWML)
	if elem == nil {
		return -1
	}
	attr, found := elem.GetAttribute("val", NamespaceWML)
...
func (pp *ParagraphProperties) SetOutlineLevel(level int) {
	if level < 0 || level > 8 {
...
func (pp *ParagraphProperties) SuppressAutoHyphens() bool {
	return pp.hasOnOffElement("suppressAutoHyphens")
}

// SetSuppressAutoHyphens sets whether automatic hyphenation is suppressed.
func (pp *ParagraphProperties) SetSuppressAutoHyphens(suppress bool) {
	pp.setOnOffElement("suppressAutoHyphens", suppress)
}
...
func (pp *ParagraphProperties) SetBidi(bidi bool) {
...
func (pp *ParagraphProperties) SetContextualSpacing(contextual bool) {
	pp.setOnOffElement("contextualSpacing", contextual)
}
...
func (pp *ParagraphProperties) SetMirrorIndents(mirror bool) {
...
func (pp *ParagraphProperties) SnapToGrid() bool {
	// Default is true, so we check for explicit false
	elem := pp.GetElement("snapToGrid", NamespaceWML)
	if elem == nil {
		return true // default
	}
	attr, found := elem.GetAttribute("val", NamespaceWML)
...
func (pp *ParagraphProperties) SetSnapToGrid(snap bool) {
	if snap {
		pp.removeElement("snapToGrid") // true is default
	} else {
...
func (pp *ParagraphProperties) TextAlignment() TextAlignmentValue {
	elem := pp.GetElement("textAlignment", NamespaceWML)
	if elem == nil {
...
func (pp *ParagraphProperties) SetTextAlignment(align TextAlignmentValue) {
	if align == "" || align == TextAlignmentAuto {
		pp.removeElement("textAlignment")
		return
	}
	elem := pp.getOrCreateElement("textAlignment")
	elem.SetAttribute(openxml.NewAttribute(NamespaceWML, "val", PrefixW, string(align)))
}
...
func (pp *ParagraphProperties) SetWordWrap(wrap bool) {
...
func (pp *ParagraphProperties) OverflowPunct() bool {
	// Default is true, so we check for explicit false
	elem := pp.GetElement("overflowPunct", NamespaceWML)
	if elem == nil {
		return true // default
	}
	attr, found := elem.GetAttribute("val", NamespaceWML)
...
func (pp *ParagraphProperties) SetOverflowPunct(overflow bool) {
	if overflow {
		pp.removeElement("overflowPunct") // true is default
	} else {
...
func (pp *ParagraphProperties) hasOnOffElement(name string) bool {
...
func (pp *ParagraphProperties) setOnOffElement(name string, value bool) {
	if value {
...
func (pp *ParagraphProperties) getOrCreateElement(name string) openxml.Element {
	elem := pp.GetElement(name, NamespaceWML)
	if elem != nil {
		return elem
	}
...
func (pp *ParagraphProperties) removeElement(name string) {
	elem := pp.GetElement(name, NamespaceWML)
	if elem != nil {
		pp.RemoveChild(elem)
	}
...
func (pp *ParagraphProperties) CloneNode(deep bool) openxml.Element {
	return &ParagraphProperties{
...
func NewIndentation() *Indentation {
	elem := openxml.NewCompositeElement(NamespaceWML, "ind", PrefixW)
	return &Indentation{CompositeElementBase: elem}
}
...
func (ind *Indentation) SetLeft(twips int) {
	ind.SetAttribute(openxml.NewAttribute(NamespaceWML, "left", PrefixW, strconv.Itoa(twips)))
}
...
func (ind *Indentation) SetRight(twips int) {
	ind.SetAttribute(openxml.NewAttribute(NamespaceWML, "right", PrefixW, strconv.Itoa(twips)))
}
...
func (ind *Indentation) SetFirstLine(twips int) {
	ind.SetAttribute(openxml.NewAttribute(NamespaceWML, "firstLine", PrefixW, strconv.Itoa(twips)))
}
...
func (ind *Indentation) SetHanging(twips int) {
	ind.SetAttribute(openxml.NewAttribute(NamespaceWML, "hanging", PrefixW, strconv.Itoa(twips)))
}

func (ind *Indentation) getIntAttribute(name string) int {
	attr, found := ind.GetAttribute(name, NamespaceWML)
	if !found {
		return 0
	}
...
func NewSpacingBetweenLines() *SpacingBetweenLines {
	elem := openxml.NewCompositeElement(NamespaceWML, "spacing", PrefixW)
	return &SpacingBetweenLines{CompositeElementBase: elem}
}
...
func (sp *SpacingBetweenLines) SetBefore(twips int) {
	sp.SetAttribute(openxml.NewAttribute(NamespaceWML, "before", PrefixW, strconv.Itoa(twips)))
}
...
func (sp *SpacingBetweenLines) SetAfter(twips int) {
	sp.SetAttribute(openxml.NewAttribute(NamespaceWML, "after", PrefixW, strconv.Itoa(twips)))
}
...
func (sp *SpacingBetweenLines) SetLine(value int) {
	sp.SetAttribute(openxml.NewAttribute(NamespaceWML, "line", PrefixW, strconv.Itoa(value)))
}

// LineRule returns the line spacing rule.
func (sp *SpacingBetweenLines) LineRule() LineSpacingRule {
	attr, found := sp.GetAttribute("lineRule", NamespaceWML)
	if !found {
...
func (sp *SpacingBetweenLines) SetLineRule(rule LineSpacingRule) {
	sp.SetAttribute(openxml.NewAttribute(NamespaceWML, "lineRule", PrefixW, string(rule)))
}

func (sp *SpacingBetweenLines) getIntAttribute(name string) int {
	attr, found := sp.GetAttribute(name, NamespaceWML)
	if !found {
		return 0
	}
	val, _ := strconv.Atoi(attr.Value())
...
func NewNumberingProperties() *NumberingProperties {
	elem := openxml.NewCompositeElement(NamespaceWML, "numPr", PrefixW)
	return &NumberingProperties{CompositeElementBase: elem}
}
...
func (np *NumberingProperties) SetNumberingId(numId int) {
	elem := np.getOrCreateElement("numId")
	elem.SetAttribute(openxml.NewAttribute(NamespaceWML, "val", PrefixW, strconv.Itoa(numId)))
}
...
func (np *NumberingProperties) SetNumberingLevel(level int) {
	elem := np.getOrCreateElement("ilvl")
	elem.SetAttribute(openxml.NewAttribute(NamespaceWML, "val", PrefixW, strconv.Itoa(level)))
}

func (np *NumberingProperties) getOrCreateElement(name string) openxml.Element {
...
func NewTabs() *Tabs {
	elem := openxml.NewCompositeElement(NamespaceWML, "tabs", PrefixW)
	return &Tabs{CompositeElementBase: elem}
}

// AddTab adds a tab stop.
func (t *Tabs) AddTab(position int, align TabAlignment, leader TabLeader) *TabStop {
...
func NewTabStop(position int, align TabAlignment, leader TabLeader) *TabStop {
	elem := openxml.NewCompositeElement(NamespaceWML, "tab", PrefixW)
	tab := &TabStop{CompositeElementBase: elem}
	tab.SetAttribute(openxml.NewAttribute(NamespaceWML, "pos", PrefixW, strconv.Itoa(position)))
	tab.SetAttribute(openxml.NewAttribute(NamespaceWML, "val", PrefixW, string(align)))
	if leader != TabLeaderNone && leader != "" {
		tab.SetAttribute(openxml.NewAttribute(NamespaceWML, "leader", PrefixW, string(leader)))
	}
	return tab
}
...
func (ts *TabStop) Position() int {
	attr, found := ts.GetAttribute("pos", NamespaceWML)
	if !found {
		return 0
	}
	val, _ := strconv.Atoi(attr.Value())
...
func (ts *TabStop) Alignment() TabAlignment {
	attr, found := ts.GetAttribute("val", NamespaceWML)
	if !found {
		return TabAlignLeft
	}
...
func (ts *TabStop) Leader() TabLeader {
	attr, found := ts.GetAttribute("leader", NamespaceWML)
	if !found {
...
func NewParagraphBorders() *ParagraphBorders {
	elem := openxml.NewCompositeElement(NamespaceWML, "pBdr", PrefixW)
	return &ParagraphBorders{CompositeElementBase: elem}
}
...
func (pb *ParagraphBorders) SetTop(style BorderStyle, size int, color string) {
...
func (pb *ParagraphBorders) SetBottom(style BorderStyle, size int, color string) {
...
func (pb *ParagraphBorders) SetLeft(style BorderStyle, size int, color string) {
...
func (pb *ParagraphBorders) SetRight(style BorderStyle, size int, color string) {
...
func (pb *ParagraphBorders) SetBetween(style BorderStyle, size int, color string) {
...
func (pb *ParagraphBorders) SetBar(style BorderStyle, size int, color string) {
	pb.setBorder("bar", style, size, color)
}

func (pb *ParagraphBorders) getBorder(name string) *Border {
...
func (pb *ParagraphBorders) setBorder(name string, style BorderStyle, size int, color string) {
...
func NewBorder(name string, style BorderStyle, size int, color string) *Border {
	elem := openxml.NewCompositeElement(NamespaceWML, name, PrefixW)
	b := &Border{CompositeElementBase: elem}
	b.SetAttribute(openxml.NewAttribute(NamespaceWML, "val", PrefixW, string(style)))
	if size > 0 {
		b.SetAttribute(openxml.NewAttribute(NamespaceWML, "sz", PrefixW, strconv.Itoa(size)))
	}
	if color != "" {
		b.SetAttribute(openxml.NewAttribute(NamespaceWML, "color", PrefixW, color))
	}
	return b
}
...
func (b *Border) Value() BorderStyle {
	attr, found := b.GetAttribute("val", NamespaceWML)
	if !found {
		return BorderNone
	}
...
func (b *Border) Size() int {
	attr, found := b.GetAttribute("sz", NamespaceWML)
	if !found {
		return 0
	}
	val, _ := strconv.Atoi(attr.Value())
...
func (b *Border) Color() string {
	attr, found := b.GetAttribute("color", NamespaceWML)
	if !found {
		return ""
	}
	return attr.Value()
...
func (b *Border) Space() int {
	attr, found := b.GetAttribute("space", NamespaceWML)
	if !found {
		return 0
	}
	val, _ := strconv.Atoi(attr.Value())
...
func (s *Shading) SetFill(color string) {
	s.SetAttribute(openxml.NewAttribute(NamespaceWML, "fill", PrefixW, color))
}

// Color returns the pattern color.
func (s *Shading) Color() string {
	attr, found := s.GetAttribute("color", NamespaceWML)
	if !found {
		return ""
	}
	return attr.Value()
...
func (s *Shading) SetColor(color string) {
	s.SetAttribute(openxml.NewAttribute(NamespaceWML, "color", PrefixW, color))
}

// Val returns the shading pattern.
func (s *Shading) Val() ShadingPattern {
	attr, found := s.GetAttribute("val", NamespaceWML)
	if !found {
		return ShadingClear
	}
...
func (s *Shading) SetVal(pattern ShadingPattern) {
	s.SetAttribute(openxml.NewAttribute(NamespaceWML, "val", PrefixW, string(pattern)))
}
