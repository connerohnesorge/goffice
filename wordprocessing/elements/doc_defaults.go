...
func (rp *DefaultRunProperties) SetFontSize(
	halfPoints int,
) {
	if halfPoints <= 0 {
		rp.removeElement("sz")
...
func (rp *DefaultRunProperties) SetFontSizeComplexScript(
	halfPoints int,
) {
	if halfPoints <= 0 {
...
func (rp *DefaultRunProperties) SetFont(
	fontName string,
) {
...
func (rp *DefaultRunProperties) SetLanguage(
	lang string,
) {
...
func (rp *DefaultRunProperties) getOrCreateElement(
	name string,
) openxml.Element {
...
func (rp *DefaultRunProperties) removeElement(
	name string,
) {
	elem := rp.GetElement(name, NamespaceWML)
	if elem != nil {
...
func (pp *DefaultParagraphProperties) SetSpacingBefore(
	twips int,
) {
...
func (pp *DefaultParagraphProperties) SetSpacingAfter(
	twips int,
) {
	elem := pp.getOrCreateElement("spacing")
	elem.SetAttribute(
...
func (pp *DefaultParagraphProperties) SetLineSpacing(
	value int,
...
func (pp *DefaultParagraphProperties) getOrCreateElement(
	name string,
) openxml.Element {
