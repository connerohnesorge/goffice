...
// Compatibility type aliases for manually written code
type (
...
// Compatibility constant aliases for BreakType
const (
	BreakPage   = BreakValuesPage
	BreakColumn = BreakValuesColumn
	BreakLine   = BreakValues(
		"",
	) // Line break is the default (no type attribute)
)
...
// Additional compatibility type aliases
type (
	TextAlignmentValue = TextAlignmentTypeValues
	TabAlignment       = TabStopValues
...
const (
	...
	LineSpacingAuto          = LineSpacingRuleValuesAuto
	TabAlignLeft             = TabStopValuesLeft
	TabLeaderNone            = TabStopLeaderCharValuesNone
	BorderNone               = BorderValuesNone
	BorderSingle             = BorderValuesSingle
	BorderDouble             = BorderValuesDouble
	ShadingClear             = ShadingPatternValuesClear
