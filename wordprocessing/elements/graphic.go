...
func NewPicture(
	...
	nvPicPr := NewNonVisualPictureProperties(
		0,
		"Picture",
	)
...
func NewNonVisualPictureProperties(
	id int,
	name string,
	...
	nvp := &NonVisualPictureProperties{
...
func NewBlipFill(relId string) *BlipFill {
	...
	fillRect := openxml.NewCompositeElement(
		NamespaceDrawingML,
		"fillRect",
		PrefixA,
	)
...
func (b *Blip) SetCompressionState(
	cstate string,
) {
	b.SetAttribute(
		openxml.NewAttribute(
