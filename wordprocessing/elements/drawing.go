...
func NewInlineDrawing(
	width, height int64,
	relId string,
) *Drawing {
	d := NewDrawing()
	inline := NewInlineDrawingElement(
		width,
		height,
		relId,
	)
...
func NewAnchorDrawing(
	width, height int64,
	relId string,
) *Drawing {
	d := NewDrawing()
	anchor := NewAnchorDrawingElement(
		width,
		height,
		relId,
	)
...
func (d *Drawing) Inline() *InlineDrawing {
	elem := d.GetElement(
		"inline",
		NamespaceDrawingMLWordprocessing,
	)
	if elem == nil {
		return nil
	}
...
func NewInlineDrawingElement(
	...
	graphicFrameLocks := openxml.NewCompositeElement(
		NamespaceDrawingML,
		"graphicFrameLocks",
		PrefixA,
	)
	graphicFrameLocks.SetAttribute(
		openxml.NewAttribute(
			"",
			"noChangeAspect",
			"",
...
func NewAnchorDrawingElement(
	...
	simplePos := openxml.NewCompositeElement(
		NamespaceDrawingMLWordprocessing,
		"simplePos",
		PrefixWP,
	)
	simplePos.SetAttribute(
		openxml.NewAttribute("", "x", "", "0"),
	)
	simplePos.SetAttribute(
		openxml.NewAttribute("", "y", "", "0"),
	)
	...
	wrapNone := openxml.NewCompositeElement(
		NamespaceDrawingMLWordprocessing,
		"wrapNone",
		PrefixWP,
	)
...
func (a *AnchorDrawing) SetSimplePos(
	useSimplePos bool,
) {
	val := "0"
	if useSimplePos {
...
func (a *AnchorDrawing) SetBehindDoc(
	behind bool,
) {
	val := "0"
	if behind {
...
func (a *AnchorDrawing) SetLayoutInCell(
	inCell bool,
) {
	val := "0"
	if inCell {
...
func (a *AnchorDrawing) SetAllowOverlap(
	allow bool,
) {
	val := "0"
	if allow {
...
func (a *AnchorDrawing) WrapSquare() {
	a.removeWrapElements()
	wrapSquare := openxml.NewCompositeElement(
		NamespaceDrawingMLWordprocessing,
		"wrapSquare",
		PrefixWP,
	)
	wrapSquare.SetAttribute(
		openxml.NewAttribute(
			"",
			"wrapText",
			"",
...
func (a *AnchorDrawing) WrapTight() {
	a.removeWrapElements()
	wrapTight := openxml.NewCompositeElement(
		NamespaceDrawingMLWordprocessing,
		"wrapTight",
		PrefixWP,
	)
	wrapTight.SetAttribute(
		openxml.NewAttribute(
			"",
			"wrapText",
			"",
...
func (a *AnchorDrawing) WrapThrough() {
	a.removeWrapElements()
	wrapThrough := openxml.NewCompositeElement(
		NamespaceDrawingMLWordprocessing,
		"wrapThrough",
		PrefixWP,
	)
	wrapThrough.SetAttribute(
		openxml.NewAttribute(
			"",
			"wrapText",
			"",
...
func (a *AnchorDrawing) WrapTopAndBottom() {
	a.removeWrapElements()
	wrapTopAndBottom := openxml.NewCompositeElement(
		NamespaceDrawingMLWordprocessing,
		"wrapTopAndBottom",
		PrefixWP,
	)
...
func (a *AnchorDrawing) insertWrapElement(
	wrap openxml.Element,
) {
	// Find effectExtent and insert after it
	effectExtent := a.GetElement(
		"effectExtent",
		NamespaceDrawingMLWordprocessing,
	)
	if effectExtent != nil {
...
func (dp *DocProperties) SetDescription(
	descr string,
) {
	dp.SetAttribute(
		openxml.NewAttribute(
...
func NewPositionH(
	...
	// Add posOffset child
	posOffset := openxml.NewLeafElementWithText(
		NamespaceDrawingMLWordprocessing,
		"posOffset",
		PrefixWP,
...
func (ph *PositionH) SetRelativeFrom(
	relativeFrom RelativeFromH,
) {
	ph.SetAttribute(
		openxml.NewAttribute(
...
// SetRelativeFrom sets the relativeFrom attribute.
func (pv *PositionV) SetRelativeFrom(
	relativeFrom RelativeFromV,
) {
	pv.SetAttribute(
		openxml.NewAttribute(
