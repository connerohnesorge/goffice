...
The Open-XML-SDK maintains a clear separation between schema-defined (fixed) attributes and unknown (extended) attributes. This research is shared across all document types (Word, Excel, PowerPoint).
