...
The OpenXmlElement system forms the foundation of the Open-XML-SDK. This document details the internal architecture based on exploration of the C# SDK. This research is shared across all document types (Word, Excel, PowerPoint).
